...
gulp.task('rename', function ()  {
    var newname;
    var author = 'David Maniak';
    var email  = 'dmaniak@student.tgm.ac.at';
    ...
    if (!newname) {
        console.log('Please write the new smartstinki name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/smartstinki.png')) {
        fs.renameSync(__dirname + '/admin/smartstinki.png',              __dirname + '/admin/' + newname + '.png');
    }
    /*if (fs.existsSync(__dirname + '/widgets/smartstinki.html')) {
        fs.renameSync(__dirname + '/widgets/smartstinki.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/smartstinki/js/smartstinki.js')) {
        fs.renameSync(__dirname + '/widgets/smartstinki/js/smartstinki.js', __dirname + '/widgets/' + newname + '/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/smartstinki')) {
        fs.renameSync(__dirname + '/widgets/smartstinki',                __dirname + '/widgets/' + newname);
    }*/
    var patterns = [
        {
            match: /smartstinki/g,
        ...
        {
            match: /Smartstinki/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Smartstinki'
        },
        {
            match: /David Maniak/g,
            replacement: author
        },
        {
            match: /dmaniak@student.tgm.ac.at/g,
            replacement: email
        }
    ];
    var files = [
